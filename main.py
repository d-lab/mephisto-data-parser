import pathlib
from src.backend.task_user_data import *
from src.backend.database_handle import *
from src.backend.csv_handle import *
import os
...
if __name__ == "__main__":
    ...
    # Path to database
    database_folder_path = os.getenv("DATABASE_PATH")

    # Path to export CSV
    csv_folder_path = os.getenv("OUTPUT_CSV_PATH")
